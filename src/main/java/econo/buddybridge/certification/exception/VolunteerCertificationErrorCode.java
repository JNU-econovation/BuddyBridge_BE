...
public enum VolunteerCertificationErrorCode implements ErrorCode {
    VOLUNTEER_CERTIFICATION_NOT_ALLOWED_MATCHING_STATUS("VC001", HttpStatus.BAD_REQUEST, "봉사 인증은 매칭 상태가 봉사 완료(VOLUNTEERING_COMPLETED)인 경우에만 가능합니다."),
    VOLUNTEER_CERTIFICATION_VOLUNTEER_MISMATCH("VC002", HttpStatus.BAD_REQUEST, "봉사자가 일치하지 않습니다. 관리자에게 문의해주세요."),
    ...
    VOLUNTEER_CERTIFICATION_ALREADY_EXISTS("VC009", HttpStatus.BAD_REQUEST, "작성한 봉사활동 인증 폼이 존재합니다."),
    ;
