...
public interface VolunteerCertificationRepository extends JpaRepository<VolunteerCertification, Long>, VolunteerCertificationCustomRepository {
    ...
    @Query(
            "SELECT new econo.buddybridge.certification.dto.detail.VolunteeringDetailResponse(" +
                    "   vc.id, " +
                    "   m.giver.nickname, " +
                    "   vc.createdAt, " +
                    ...
                    "JOIN vc.matching m " +
                    "JOIN m.post p " +
                    "WHERE vc.matching.giver = :member AND vc = :volunteerCertification"
    )
    VolunteeringDetailResponse findVolunteeringDetailResponseByMemberAndCertification(@Param("member") Member member, @Param("volunteerCertification") VolunteerCertification volunteerCertification);
    ...
    CertificationDetailQueryDto findCertificationDetailQueryDtoByVolunteerCertification(@Param("volunteerCertification") VolunteerCertification volunteerCertification);
